...
[TODO: add your own hardware notes here — which model sizes you have actually run locally, what hardware, and what response latency you saw, since this varies enormously by machine and is the kind of specific number that is worse to guess than to state plainly as unverified]

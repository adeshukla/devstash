...
description: 'See how I built a self-hosted n8n workflow using Google Sheets, Groq LLM, and Gmail to send personalized cold emails with my resume attached.'
author: 'Adesh Shukla'
...
Local models still have real uses (privacy, no per-request cost, offline work), and I wrote up [how I decide between local and API-based models](/blog/running-local-llms-with-ollama) separately.

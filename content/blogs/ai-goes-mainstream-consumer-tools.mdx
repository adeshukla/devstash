...
AI features stopped being a thing you had to seek out — a chat window on a dedicated site — and became something baked directly into the apps ordinary, non-technical people already use every day: photo apps that generate and edit images inline, video apps with AI dubbing and generation built into the standard export flow, finance apps offering AI-driven spending insights and automated categorization as a default feature, not an add-on. The shift that matters here is not capability, it is *placement* — the same underlying models, moved from "a tool you deliberately visit" to "a feature already sitting inside the app you opened for something else."

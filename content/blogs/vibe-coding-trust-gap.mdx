...
[TODO: describe your specific pre-merge checklist for AI-generated changes — e.g. what you always re-read manually, what test coverage you require before merging, any tooling you've added specifically for this]

The general shape, regardless of the specifics: I stopped treating "the assistant ran it and it worked" as equivalent to "I reviewed it." Those are different levels of confidence, and conflating them is exactly how a plausible-looking bug reaches production. A quick pass reading the diff line by line, asking "what input would break this," takes a few minutes and catches most of what a single successful run doesn't.

...
tags: ['vibe-coding', 'ai-workflows', 'code-review', 'ai-assistants', 'ai-coding-agents']
readingTime: 5
...
The same gap shows up in consumer products with arguably higher stakes, because the person reviewing the output is often a non-technical user. [More on that shift](/blog/ai-goes-mainstream-consumer-tools).
...
Related reading if you want the other half of this: [why I still write tests for AI-generated code](/blog/why-i-still-test-ai-generated-code) goes into the specific testing habits that catch this gap in practice. And if you're working solo, [the one-person product team post](/blog/one-person-product-team-vibe-coding) covers what that speedup actually removes and what it doesn't.

---
title: 'Next.js 15 App Router: Patterns I Actually Use'
slug: 'nextjs-15-app-router-patterns'
description: 'Practical patterns from building a real Next.js 15 project: async searchParams, MDX with next-mdx-remote/rsc, generateStaticParams on dynamic routes, and why Server Components change the way you think about data fetching.'
author: 'Adesh Shukla'
createdAt: '2025-05-20'
updatedAt: '2025-05-20'
category: 'frontend'
tags: ['nextjs', 'react', 'typescript', 'app-router']
featuredImage: '/images/blog/nextjs-15-patterns.webp'
readingTime: 6
canonical: 'https://devstash.me/blog/nextjs-15-app-router-patterns'
draft: false
featured: false
---

I've been building DevStash — this site — on Next.js 15 App Router with TypeScript strict mode. Some patterns I expected from the docs. Others I only found by reading the breaking-change notes carefully, or by hitting confusing runtime errors at 11pm.

Here are the ones worth documenting.

## async searchParams in Page Components

This is the biggest "gotcha" in Next.js 15. `searchParams` (and `params`) are now **Promises** — you have to `await` them before accessing any property.
...
If a `'use client'` component calls `useSearchParams()`, it must be wrapped in a `<Suspense>` boundary at the parent level. Without it, Next.js 15 throws a build error:

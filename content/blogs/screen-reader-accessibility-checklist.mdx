...
That same accessibility tree now has a second audience: Lighthouse's Agentic Browsing category checks it too, because AI agents read a page through the same structure screen readers do. I covered [what that category actually measures](/blog/agentic-browsing-lighthouse) separately.

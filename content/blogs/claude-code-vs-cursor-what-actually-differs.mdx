...
category: 'devtools'
tags: ['claude-code', 'cursor', 'ai-assistants', 'ai-coding-agents', 'developer-tools']
readingTime: 5
...
That's the actual axis the comparison sits on: **in-editor agent vs. standalone agent with a shell** — a distinction I've argued elsewhere is [architecture, not autocomplete](/blog/ai-coding-assistants-architecture-not-autocomplete). Everything else — model choice, pricing, specific features — sits downstream of that one structural decision.
...
The protocol that standardizes how an agent reaches tools like a database, an API, or a file is MCP, which I [explained for developers who just want to ship](/blog/model-context-protocol-explained-for-working-developers).

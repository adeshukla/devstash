...
Layout stability has a second audience now as well. Lighthouse's Agentic Browsing category scores CLS, because an AI agent that clicks based on a snapshot taken a moment earlier can miss entirely if the page shifts. More on [what that category checks](/blog/agentic-browsing-lighthouse).

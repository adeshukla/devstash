...
For how this sits inside the wider stack — Next.js 16, TypeScript strict mode, and a file-based content layer — I wrote up the whole architecture in [Building DevStash](/blog/building-devstash-with-nextjs).

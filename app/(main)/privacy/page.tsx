...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'How DevStash (devstash.me) collects, uses, and protects your personal information.',
  canonical: 'https://devstash.me/privacy',
})
        ...
        <div className="mx-auto max-w-3xl px-6">
          <div className="text-ds-muted flex flex-col gap-10">
            ...
            <PolicySection title="4. Third-Party Services">
              ...
              <ul>
                <li>
                  <strong className="text-ds-text">Vercel</strong> — hosting and deployment (servers
                  in the USA/EU).
                </li>
                <li>
            ...
            <PolicySection title="6. Data Retention">
              <p>
                ...
                inquiry. Analytics data is retained per Google&apos;s default retention settings (14
                months).
              </p>
            </PolicySection>

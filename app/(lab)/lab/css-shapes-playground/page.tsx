...
export default function CssShapesPlaygroundPage() {
  return (
    <>
      <LabToolSchema slug="css-shapes-playground" path="/lab/css-shapes-playground" />
        ...
        <section className="border-ds-border border-b px-6 py-16">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="text-ds-muted mb-8">
              ...
              build a shape that doesn&apos;t exist anywhere else — then add an animation and copy
              the exact CSS for what&apos;s on screen.
            </p>
            <ShapeCustomizer />
          </div>
        </section>
        ...
        <section className="border-ds-border border-b px-6 py-16">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="text-ds-muted mb-8">
              ...
              panel, a gradient with a real middle stop, and a shadow built from stacked layers
              rather than one flat blur. Every control takes your own colour, and each one copies
              out as either CSS or a Tailwind arbitrary-value class.
            </p>
            <SurfaceStudio />
          </div>
        </section>

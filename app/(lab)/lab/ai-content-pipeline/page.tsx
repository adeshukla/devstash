...
import { LabToolSchema } from '@/components/lab/LabToolSchema'
  ...
  return (
    <>
      <LabToolSchema
        ...
        path="/lab/ai-content-pipeline"
        title="AI Content Pipeline"
        description="A live 3-step LLM pipeline: scaffold an honest draft that marks where you add real code and numbers, run a copy-edit pass to strip AI-tell phrases, and produce SEO frontmatter."
      />
      ...
      <main className="bg-ds-bg min-h-screen">
        <section className="border-ds-border border-b px-6 py-20 text-center sm:py-24">
          <div className="mx-auto max-w-2xl">
            ...
            <p className="text-ds-muted mt-6 text-lg leading-relaxed">
              A real 3-step Groq LLM chain, not a mockup: an honest scaffold that marks where you
              add real code and numbers instead of faking them, a copy-edit pass that strips AI-tell
        ...
        <section className="border-ds-border border-t px-6 py-16">
          <div className="mx-auto max-w-2xl">
            ...
            <p className="text-ds-muted leading-relaxed">
              First drafts from an LLM tend to lean on the same tells — “in conclusion”, “delve
              into”, “leverage”, “comprehensive”. The second call is a targeted rewrite instructed
              to avoid that exact list, and the metrics panel counts how many of those phrases show
              up before and after — a small, concrete eval instead of just trusting that it worked.
            </p>
          </div>
        </section>
        ...
        <section className="border-ds-border border-t px-6 py-16">
          <div className="mx-auto max-w-2xl">
            ...
            <p className="text-ds-muted leading-relaxed">
              Your topic, keywords, tone, and length go to a Next.js route handler, which makes
              three sequential calls to Groq’s{' '}
              <code className="text-ds-accent">openai/gpt-oss-20b</code> model — scaffold,
              copy-edit, then a JSON frontmatter call matching this blog’s real frontmatter shape.
              The scaffold step is told to leave <code className="text-ds-accent">[TODO: …]</code>{' '}
              placeholders wherever it would otherwise have to invent code, a benchmark, or personal
              experience — an honest draft you finish, not fake content you publish. Nothing is
              saved anywhere; the output only exists in your browser for this run.
            </p>
